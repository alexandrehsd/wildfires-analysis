...
```{r}
tidy %>% ggplot(aes(x = dia_ano)) +
  geom_line(aes(y = `2015`, col = "#bfac8e")) +
  geom_line(aes(y = `2016`, col = "#d5f56c")) +
  geom_line(aes(y = `2017`, col = "#c95b5b")) +
  geom_line(aes(y = `2018`, col = "#b85dd4")) +
  geom_line(aes(y = `2019`), col = "#917783") +
  scale_x_continuous("Day of the year", breaks = seq(from = 1, to = 366, by = 50)) +
