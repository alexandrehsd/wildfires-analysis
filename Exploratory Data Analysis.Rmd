...
data %>% 
  ...
  geom_bar(aes(fill = bioma), stat = 'identity') + 
    ...
    labs(y = "Focos de incêndios (milhares)", title = 'Focos de incêndio no Brasil por mês') +
    theme(plot.title=element_text(size=10, 
                                      face="bold", 
                                      family="Arial",
                                      hjust=0.5,
              ...
              legend.position = "none",
              plot.caption = element_text(size = 6)) + # Y axis text
              ggsave(paste0(path_ch3, "trends-byMonthbyBioma.png"), dpi = "retina", width = 10, height = 8, units = "cm")
```
...
colors_df %>%
  ggplot(aes(x = mes)) +
  geom_bar(position = "dodge", aes(fill = color)) +
  ...
  labs(y = "Quantidade de incêndios", x = "Mês", title = 'Quantidade mensal de incêndios',  caption="Fonte: Elaborado pelo Autor") +
    theme(plot.title=element_text(size=10, 
              ...
              ggsave(paste0(path_ch3, "count-byMonth.png"), dpi = "retina", width = 10, height = 8, units = "cm")
  ...
  ggplot(aes(x = date, group = 1)) +
   ...
   labs(y = "Quantidade de incêndios", x = "Mês/Ano", title = 'Quantidade de incêndios por dia',  caption="Fonte: Elaborado pelo Autor") +
    theme(plot.title=element_text(size=10, 
              ...
              legend.position = "none",
              plot.caption = element_text(size = 8)) + # Y axis text
              ggsave(paste0(path_ch3, "count-byDay.png"), dpi = "retina", width = 10, height = 8, units = "cm")
```
...
p <- periodogram(signal_INPE$n, ylab = "Periodograma", xlab = "Frequência", lwd = 1.5)
...
freqs %>% ggplot(mapping = aes(x = freq, y = spec)) +
  ...
  theme(plot.title=element_text(size=10, 
              ...
              legend.position = "none",
              plot.caption = element_text(size = 8)) + # Y axis text
              ggsave(paste0(path_ch3, "psd.png"), dpi = "retina", width = 10, height = 8, units = "cm")
```
